...
#define P_LOOKAHEAD_MAX 50.0           // m
#define P_LOOKAHEAD_TIME 4.0           // s
#define P_GOAL_OFFSET 1.0              // m
#define P_ERR_TOLERANCE 0.1            // m
#define P_TIME_GAP 1.0                 // s
#define P_MAX_ACCEL 2.5                // m/s^2
#define P_SLOW_SPEED 2.0               // m/s
#define P_SPEED_LIMIT 15.0             // m/s
#define P_STOP_LINE_BUFFER 5.0         // m
...
constexpr std::array<float, 3> CIRCLE_RADII = {2.5, 2.5, 2.5};     // m
